...
class InMemoryDB(InventoryDB):
    ...
    def _add_db_item(self, object: typing.Any, validate_method: typing.Callable, collection: typing.Dict[int, typing.Any]) -> typing.Any:
    ...
    def add_item_metadata(self, metadata: ItemMetadata) -> ItemMetadata:
        ...
        """
        return self._add_db_item(metadata, self._validate_item_metadata, self.item_metadata)
